	       ...
	       WindowListener, ClipboardOwner
{
	...
	menuAbout = new MenuItem("About VJIntranet Chatting");
	...
	if (adminConsole)
	    roomOwner(true);
	setTitle("VJTI Intranet Chatting VERSION: " + Orbit.VERSION + " - online at " + host);
	return;
    }
	...
	try {
		...
		errorString += "\nIf you think this is a bug, please send a "
		    + "bug report to malshikhareaditya@gmail.com\n";
	...
	if (E.getSource() == menuAbout)
	    {
String abouttext = new String("VJTI Intranet Chatting VERSION" + Orbit.VERSION + "\nCopyright ORBIT IT CONSULTING (P) LTD.\n\n");
		
		new OrbitTextDialog(this, "About VJIntranet Chatting", 
				      abouttext, 60, 22,
